...
def define_optimizer_dm_re_recon(target_encoder_full,  param_decoder_full,
                                 recon_full,
                                 re_net_full,
    ...
    all_parameters = (target_encoder_full_params + 
                      decoder_full_params + re_net_full_params + #embedding_params +
                      recon_full_params + src_encoder_params + recon_src_params)
