...
class shapenet_dataset(Dataset):
    def __init__(self, config):
        ...
        # chair_train:4824 /mnt/d/20240308/U-RED/data/generated_datasplits/orion/u/mikacuy/part_deform/generated_datasplits/chair_500_train.h5
...
if __name__ == "__main__":
    ...
    config_path = '/mnt/d/20240308/U-RED/config/config_test_chair.json'
    config = json.load(open(config_path, 'rb'))
    dataset = shapenet_dataset(config)
    
    # points：2048 x 3, ids: 1, labels: 1024, semantics: 1024, points_occ: 1024 x 3, points_occ_mask: 1024, ori_point_occ: 1024 x 3
    points, ids, labels, semantics, points_occ, points_occ_mask, ori_point_occ = dataset.__getitem__(1200) 
